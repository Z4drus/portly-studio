...
/// Provider marks as unit-box outlines, filled even-odd.
///
/// Claude and OpenAI were traced off Codenotch's design frame (marching
/// squares over the 46px glyph, smoothed, simplified); Cursor and Grok are
/// flattened from the vendors' own SVGs, so they are exact at any size.
enum GlyphOutline {
